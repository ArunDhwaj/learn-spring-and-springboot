...
export const retrieveTodosForUserApi = (username) => apiClient.get(`/users/${username}/todos`);
...
export const putTodoApi = (username, id, todo) => apiClient.put(`/users/${username}/todos/${id}`, todo);
